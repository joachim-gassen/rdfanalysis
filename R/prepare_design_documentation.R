...
#' documentation of your research design.
#'
...
#' @details Output is generated by \code{rmarkdown}
#' and saved to a PDF file, so you need a local \code{rmarkdown} installation
#' that is capable to produce PDF files.
#' @examples
#' \dontrun{
