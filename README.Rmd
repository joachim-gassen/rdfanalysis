...
The below displays a specification curve ([Simonsohn, Simmons and Nelson](https://www.nature.com/articles/s41562-020-0912-z)) based
...
This is a project of the [Open Science Data Center](https://www.accounting-for-transparency.de/projects/open-science-data-center/) and funded by the [Deutsche Forschungsgemeinschaft (DFG, German Research Foundation)](https://www.dfg.de/en/index.jsp): [Project-ID 403041268 – TRR 266 Accounting for Transparency](https://www.accounting-for-transparency.de).
