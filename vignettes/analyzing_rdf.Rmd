...
We will estimate the respective coefficient for GDP per capita in a multiple regression framework on a panel data set of country-year data provided by the [World Bank](https://data.worldbank.org) (GDP per capita, life expectancy at birth and unemployment rates), and the [Wittgenstein Center](http://dataexplorer.wittgensteincentre.org/wcde-v2/) for mean years of schooling received by country inhabitants being 15 years or older. As the schooling data is available at 5 year intervals only, I interpolate the years in-between to keep the data at annual frequency (another research degree of freedom, I know ...).
